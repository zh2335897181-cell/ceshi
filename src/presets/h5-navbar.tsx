...
export const H5NavBar = () => {
  ...
  const updateNavState = useCallback(() => {
    ...
    setNavState({
      ...
      leftIcon: computeLeftIcon(cleanRoute, tabBarPages, pages.length, cleanHomePage),
    });
  }, []);
  ...
  const shouldRender = IS_H5_ENV && navState.navStyle !== 'custom';
      ...
      >
        {navState.leftIcon === LeftIcon.Back && (
          <View
            ...
            onClick={handleBack}
          >
            <View className="i-lucide-chevron-left w-6 h-6" style={{ color: iconColor }} />
          </View>
        )}
        {navState.leftIcon === LeftIcon.Home && (
          ...
          >
            <View className="i-lucide-house w-6 h-6" style={{ color: iconColor }} />
          </View>
        )}
        <Text
